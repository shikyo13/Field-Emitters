...
4. Feed Forge Energy into any post with a cable, generator or energy cell from another mod. Connected posts pool their stored energy, so one input can run the whole perimeter.
