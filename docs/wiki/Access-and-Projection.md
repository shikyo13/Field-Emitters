...
A Card Holder carries 16 cards. In your inventory, right-click the holder with a card on the cursor to insert it, or with an empty cursor to remove one. Carry it in your inventory. Curios equipment slots are not supported on this build.
