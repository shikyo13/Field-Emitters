...
public final class EntityFilter {
  ...
  public boolean matches(Entity entity, UUID owner) {
    ...
    var subject = new com.zeromods.core.fabric.MinecraftEntitySubject(entity);
    boolean mob =
    ...
    var selection =
        new com.zeromods.core.filter.EntitySelection(
            ...
            entityType,
            itemType);
    return selection.matches(new com.zeromods.core.fabric.MinecraftEntitySubject(entity), owner);
  }
